...
ASI ELARA uAgent only analyzes these 6 whitelisted pairs only because of rate limits of qwen3, use Our telegram bot to access Full ELARA Agent for all pairs support ([https://t.me/Elara_pair_agent_bot](https://t.me/Elara_pair_agent_bot)) :
- SOL/BTC
- BTC/SOL
- ETH/BTC
- BTC/ETH
